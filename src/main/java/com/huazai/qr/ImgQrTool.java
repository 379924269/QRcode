    ...
    public static void main(String[] args) throws IOException {
        for (int i = 1; i <= 1; i++) {
            QrImage para = new QrImage.Builder()
                    .setFileOutputPath("C:\\Users\\Public\\Pictures\\Sample Pictures" + i + ".jpg" )
                    .setQrContent("https://user.qzone.qq.com/379924269" )
                    .setQrHeight(800)
                    .setQrWidth(800)
                    .setQrIconFilePath("C:\\Users\\Public\\Pictures\\Sample Pictures\\2.jpg" )
                    .setQrIconWidth(512)
                    .setTopWrodHeight(0)
                    .setWordContent("")
                    .setWordSize(1).build();
